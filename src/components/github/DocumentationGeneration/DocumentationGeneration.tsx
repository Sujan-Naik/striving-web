...
import {ParsedFile, parseFileContent} from "@/components/github/DocumentationGeneration/utils/ParseMaster"; // Swift parsing
...
export default function DocumentationGeneration({ owner, repo, initialBranch = 'main' }: DoxygenProps) {
