                ...
                <HeadedCarousel variant={VariantEnum.Outline}>
                    <HeadedCard variant={VariantEnum.Primary}>
                        <div className="flex items-center gap-3 p-4">
                            ...
                            <div>
                                <h3 className="font-semibold inline-flex items-center gap-2"><FaProjectDiagram
                                    className="text-2xl"/> Projects</h3>
                    ...
                    <HeadedCard variant={VariantEnum.Primary}>
                        <div className="flex items-center gap-3 p-4">
                            <div>
                                <h3 className="font-semibold inline-flex items-center gap-2"><FaCubes
                                    className="text-2xl"/> Features</h3>
                                <p className="text-sm opacity-75">
                    ...
                    <HeadedCard variant={VariantEnum.Primary}>
                        <div className="flex items-center gap-3 p-4">
                            <div>
                                <h3 className="font-semibold inline-flex items-center gap-2"><FaBook
                                    className="text-2xl"/> Docs & Manuals</h3>
                                <p className="text-sm opacity-75">
                    ...
                    <HeadedCard variant={VariantEnum.Primary}>
                        <div className="flex items-center gap-3 p-4">
                            <div>
                                <h3 className="font-semibold inline-flex items-center gap-2"><FaExchangeAlt
                                    className="text-2xl"/> Flexible Structure
                                </h3>
                                <p className="text-sm opacity-75">
