    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Discover how ideas transform into comprehensive software projects through our structured workflow of
                    features, documentation, and seamless integrations with Github.
                </p>
                <div
            ...
            <section className="w-full">
                ...
                >
                    ...
                    <p
                        style={{color: 'var(--foreground-secondary)'}}
                    >
                        We offer <HeadedLink variant={VariantEnum.Outline} href={'/github'}>an AI powered Github
                        Repository generator</HeadedLink>
    ...
    return (
        <figure className="w-full">
            ...
            >
                ...
                {/* Background sections */}
                <rect x="0" y="0" width={leftX + sx(500)} height={viewH} fill="url(#accentGradient)" rx="12"
                      opacity="0.2"/>
                <rect x={rightX - sx(200)} y="0" width={sx(500)} height={viewH} fill="url(#accentGradient)" rx="12"
                      opacity="0.15"/>
